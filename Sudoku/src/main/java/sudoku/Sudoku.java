...
public class Sudoku {
	...
	private void buildMenu(JFrame frame) {
		...
		easyOption.addActionListener((ActionEvent e) -> {
			createGame(getInput(Thread.currentThread().getContextClassLoader().getResourceAsStream("Games/easy.txt")));
		});

		JMenuItem mediumOption = new JMenuItem("Medium");
		mediumOption.addActionListener((ActionEvent e) -> {
			createGame(getInput(Thread.currentThread().getContextClassLoader().getResourceAsStream("Games/medium.txt")));
		});

		JMenuItem hardOption = new JMenuItem("Hard");
		hardOption.addActionListener((ActionEvent e) -> {
			createGame(getInput(Thread.currentThread().getContextClassLoader().getResourceAsStream("Games/hard.txt")));
		});
	...
	private void createGame(int[][] arr) {
	...
	private void buildOptionsPanel(JFrame frame) {
		...
		options[9].setIcon(new ImageIcon(Toolkit.getDefaultToolkit()
		...
		options[10].setIcon(new ImageIcon(Toolkit.getDefaultToolkit()
		...
		options[11].setIcon(new ImageIcon(Toolkit.getDefaultToolkit()
